...
export const countryFilters = [
  ...
  { id: "CN", name: "中国 GB", nameEn: "China GB" },
  { id: "ISO", name: "国际 ISO", nameEn: "ISO" },
  { id: "US", name: "美国 ASTM", nameEn: "US ASTM" },
  { id: "EU", name: "欧洲 EN", nameEn: "Europe EN" },
  { id: "DE", name: "德国 DIN", nameEn: "Germany DIN" },
];

export const standardCategories = [
  { id: "all", name: "全部类别", nameEn: "All categories" },
  { id: "test-mechanical", name: "力学试验", nameEn: "Mechanical testing" },
  { id: "test-physical", name: "物理/热学试验", nameEn: "Physical / thermal testing" },
  { id: "test-chemical", name: "化学/耐腐蚀试验", nameEn: "Chemical / corrosion testing" },
  { id: "test-fire", name: "阻燃/燃烧试验", nameEn: "Fire / flammability testing" },
  { id: "raw-material", name: "原材料", nameEn: "Raw materials" },
  { id: "product-pipe", name: "管道", nameEn: "Pipes" },
  { id: "product-tank", name: "储罐/容器", nameEn: "Tanks / vessels" },
  { id: "product-profile", name: "型材/格栅", nameEn: "Profiles / gratings" },
  { id: "product-general", name: "通用制品", nameEn: "General products" },
  { id: "design", name: "设计/工程规范", nameEn: "Design / engineering" },
  { id: "marine", name: "船舶/海工", nameEn: "Marine / offshore" },
  { id: "construction", name: "建筑加固", nameEn: "Construction / retrofit" },
  { id: "electrical", name: "电气/电工", nameEn: "Electrical" },
];

export const processTagOptions = [
  { id: "all", name: "全部工艺", nameEn: "All processes" },
  { id: "general", name: "通用", nameEn: "General" },
  { id: "hand-layup", name: "手糊", nameEn: "Hand layup" },
  { id: "winding", name: "缠绕", nameEn: "Filament winding" },
  { id: "pultrusion", name: "拉挤", nameEn: "Pultrusion" },
  { id: "molding", name: "模压", nameEn: "Compression molding" },
  { id: "rtm", name: "RTM", nameEn: "RTM" },
  { id: "vacuum", name: "真空导入", nameEn: "Vacuum infusion" },
  { id: "repair", name: "修补/加固", nameEn: "Repair / retrofit" },
];
